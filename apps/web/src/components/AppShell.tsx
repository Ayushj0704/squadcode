      ...
      <div style={{ position: "relative" }} ref={profileRef}>
        ...
        {profileDropOpen && (
          <div className="ds-dropdown" style={{ width: 260 }}>
            ...
            {/* Upgrade & Sign Out */}
            <div style={{ padding: "8px 8px", borderTop: "1px solid var(--p-border)", display: "flex", flexDirection: "column", gap: 4 }}>
              <button
              ...
              <button
                onClick={() => { setProfileDropOpen(false); void signOut(); }}
                style={{
                  display: "flex", alignItems: "center", gap: 8,
                  width: "100%", padding: "9px 10px", borderRadius: 8,
                  background: "none", border: "none", cursor: "pointer",
                  fontSize: 12.5, fontWeight: 600, color: "#FF4D4D",
                }}
                onMouseEnter={(e) => (e.currentTarget.style.background = "var(--p-grey)")}
                onMouseLeave={(e) => (e.currentTarget.style.background = "none")}
              >
